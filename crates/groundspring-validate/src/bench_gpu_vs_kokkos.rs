...
fn main() {
    ...
    // Warmup: run a small GPU dispatch to amortize device init
    if gpu_active {
    ...
    // ------------------------------------------------------------------
    // 1. Anderson localization — Lyapunov exponent (500 realizations)
    // ------------------------------------------------------------------
    {
        ...
        // Also benchmark single-potential Lyapunov for completeness
    ...
    // ------------------------------------------------------------------
    // 2. Statistical reductions — mean, variance, Pearson r (N=1M)
    // ------------------------------------------------------------------
    {
    ...
    // ------------------------------------------------------------------
    // 3. Bootstrap resampling (N=10k, B=5k)
    // ------------------------------------------------------------------
    {
