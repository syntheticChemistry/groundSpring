...
mod spectral;
pub use spectral::{
    SpectralDiagnostics, SpectralPhaseLabel, detect_transition, empirical_spectral_density,
    marchenko_pastur_upper, spectral_diagnostics, spectral_diagnostics_auto,
};
