...
- V113: GemmF64 transpose delegation, RetryPolicy + CircuitBreaker (IPC resilience), 4-format capability parsing, exit_code constants (UNIBIN_ARCHITECTURE_STANDARD). 930+ tests.
