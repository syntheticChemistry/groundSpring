...
- V122: Cast evolution + module extraction (`lib.rs` 607→182, `validate/lib.rs` 769→226, 20+ bare `as` casts→named helpers, `cast` module promoted to `pub`, `eps::SSA_FLOOR` unconditional, `deny.toml` cleaned), March 24, 2026.
