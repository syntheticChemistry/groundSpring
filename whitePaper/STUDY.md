...
- **Phase 2a (DONE)**: Tier A rewire — **46 active delegations + 7 pending ToadStool (37 CPU + 9 GPU)**. Rust is **11.5× faster** than Python (excl. LAPACK-bound; Exp 009: 47.7× from Sturm tridiag). 28/28 parity proven. V46: 490+ workspace tests, 292/292 checks, 19 metalForge workloads, 5 substrates, architecture-aware GPU routing, `linalg` module, typed `InputError`
