...
- **Phase 2a (Barracuda)**: 32 active delegations + 9 pending ToadStool (25 CPU + 7 GPU). 11.5× faster than Python (excl. LAPACK-bound). Exp 009: 47.7× from Sturm tridiag. 28/28 parity proven.
