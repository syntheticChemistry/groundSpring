...
**NUCLEUS**: biomeOS Neural API live (V110) — Tower, Node, Squirrel validated; NestGate data pipelines (NCBI, NOAA, IRIS) with sovereign fallback. Adaptive health probing, direct primal discovery. Typed capability-based discovery. V110: cross-ecosystem absorption, `#[expect(reason)]`, Python tolerance mirror, toadStool direct dispatch, dual-format capability parsing.
