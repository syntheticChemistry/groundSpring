...
**Total**: 395/395 validation checks across 35 experiments, 10 domains. 903 Rust workspace tests + 261 Python provenance tests.
...
**barraCuda**: 101 active delegations (60 CPU + 41 GPU) — barraCuda v0.3.3, toadStool S128, coralReef Phase 9.
...
**93 active delegations (56 CPU + 37 GPU) — toadStool S96c (d77fc546), barraCuda `e1184f3`**.
...
34/34 experiments validated. 824 Rust workspace tests + 390 Python = 1214 total.
