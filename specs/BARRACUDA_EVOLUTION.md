...
**Last updated**: March 2, 2026 (V66 — 76 delegations (44 CPU + 32 GPU), 776 tests, ToadStool S86 (`7e01ac7e`) — V66: stats Tier A GPU completion (MAE, NSE, R² via `FusedMapReduceF64`), bistable batch ODE GPU (`BatchedOdeRK4F64`), 30 metalForge workloads, 30 tolerance specs. V65: docs sweep + comprehensive ToadStool absorption handoff)
